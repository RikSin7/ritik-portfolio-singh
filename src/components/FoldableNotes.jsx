...
import notepot from "../assets/images/NotepotSs.png";
import {
  motion,
  useMotionValue,
  useMotionValueEvent,
...
function FoldableNotes({ setIsHovering, isOpenNotes, setIsOpenNotes }) {
        ...
        >
          ...
          <motion.div
            className={`map-image bg-[size:300%] translate-x-full ${
              isOpenNotes && isClicked && notepot && "border-none rounded-l-2xl"
            } border-r border-black shadow-2xl shadow-black`}
            style={{
              backgroundImage: `${
                isOpenNotes && isClicked && notepot
                  ? `url(${notepot})` // No gradient when currConv
          ...
          <motion.div
            className={`map-image bg-[size:300%] bg-right -translate-x-full ${
              isOpenNotes && isClicked && notepot && "border-none rounded-r-2xl"
